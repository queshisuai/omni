...
import { formatSupportConversationStatus, formatSupportSender } from '@/lib/support-tools'
            ...
            {conversations.length === 0 ? (
              ...
              >
                <div className="mb-2 flex items-center justify-between gap-2">
                  <span className="truncate text-[14px] font-semibold text-[#111]">{item.subject}</span>
            ...
            <>
              <div className="flex h-16 items-center justify-between border-b border-gray-200 bg-white px-6">
                <div>
                  ...
                  <div className="mt-1 text-[12px] text-gray-500">用户 ID：{active.userId} · {formatSupportConversationStatus(active.status)}</div>
                </div>
