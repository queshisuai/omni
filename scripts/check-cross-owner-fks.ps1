...
Add-Owners -Tables @("user", "user_auth", "sms_code", "organizer_application", "organizer_application_material", "user_asset", "user_attendee", "privacy_audit_log", "support_account", "support_conversation", "support_message", "support_conversation_note", "support_conversation_tag", "support_conversation_audit", "support_quick_reply", "user_browse_history", "rbac_role", "rbac_permission", "rbac_role_permission", "user_permission_override", "operation_audit_log", "exception_task", "exception_task_evidence", "reconciliation_batch", "reconciliation_detail", "reconciliation_difference", "cs_skill_group", "cs_agent_member", "cs_session_audit") -Owner "java-user"
