...
Add-Owners -Tables @("user", "user_auth", "sms_code", "organizer_application", "organizer_application_material", "user_asset", "user_attendee", "privacy_audit_log", "support_account", "support_conversation", "support_message", "support_conversation_note", "support_conversation_tag", "support_conversation_audit", "support_quick_reply", "support_ai_suggestion", "user_browse_history", "rbac_role", "rbac_permission", "rbac_role_permission", "user_permission_override", "operation_audit_log", "exception_task", "exception_task_evidence", "reconciliation_batch", "reconciliation_detail", "reconciliation_difference", "cs_skill_group", "cs_agent_member", "cs_session_audit") -Owner "java-user"
Add-Owners -Tables @("category", "artist", "activity_artist", "tour", "station", "activity", "session", "ticket_type", "ticket_type_area", "session_seat", "venue", "venue_area", "venue_seat", "venue_application", "venue_application_material", "reservation", "seat", "review", "moment", "stock_log", "venue_seat_layout_template", "venue_seat_layout_template_section", "venue_default_layout", "venue_default_layout_section", "activity_seat_layout", "activity_seat_layout_section", "session_seat_layout", "session_seat_layout_section", "seat_block", "seat_override", "ticket_group", "layout_section", "performance_subscription", "activity_review", "activity_question", "activity_review_report", "activity_marketing_rule", "activity_risk_resolution", "search_history", "seat_layout_version", "seat_layout_version_block", "seat_layout_version_override", "seat_layout_version_ticket_group", "seat_layout_version_group_binding", "ticket_asset", "private_asset", "station_config_version") -Owner "java-ticket"
