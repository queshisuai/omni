...
$schemaColumns = @{
    ...
    "support_conversation" = New-ColumnSet @("id", "user_id", "subject", "status", "source_type", "assigned_agent_id", "last_message", "create_time", "update_time", "closed_at", "first_response_due_at", "first_agent_replied_at", "last_user_message_at", "last_agent_message_at", "close_request_reason", "close_requested_by", "close_requested_at", "escalated_to_admin", "escalation_reason", "escalated_at")
