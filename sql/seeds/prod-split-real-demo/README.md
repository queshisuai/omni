...
- 补齐重点艺人头像本地归档：`artist-avatars.json` 记录来源页和本地路径，避免艺人档案复用活动海报。
- 补齐平台主办方运营员演示数据：统一中文名称、主办方分配、风险等级、下次跟进、跟进记录和运营审计。
- 补齐客服上下文工作台演示数据：客服账号、带订单和退款主题的会话、消息、备注、标签、审计、快捷回复，并复用订单、退款、票夹、候补、抢票和通知 seed。
